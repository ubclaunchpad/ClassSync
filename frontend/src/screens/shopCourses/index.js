...
const ShopCourses = () => {
  ...
  const handleRegister = async () => {
    setRegistrationError(null);
    console.log(
      `Registered ${selectedStudent.name} (id: ${selectedStudent.id}) for course with id: ${selectedCourse.course_id}`
    );
    let url = "http://localhost:8080/registrations";
    try {
      console.log(
        "Trying to register student for course id: ",
      ...
      >
        ...
        {courses &&
          courses.map((course, index) => (
            ...
            >
              <img
                src="https://images.squarespace-cdn.com/content/v1/63b64f0411726e490366a3cb/1672892283063-R28O2XMQOO9VTVXFVAKM/class_covers_WEBSITE-Scratch-Bg-.jpg?format=1000w"
                alt="Course"
                style={{
                  width: "240px",
                  height: "160px",
              ...
              <div style={{ flex: 1 }}>
                <h3 style={{ color: "#103DA2", marginBottom: "10px" }}>
                  {course.course_difficulty} {course.course_name}
                </h3>
                <p style={{ color: "grey", marginBottom: "10px" }}>
                  Target Age: {course.target_age} | Prerequisites:{" "}
              ...
              >
                {selectedCourse && (
                  <h2 style={{ marginBottom: "20px" }}>
                    Register for {selectedCourse.course_difficulty}{" "}
